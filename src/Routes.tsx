...
import { app_path, first_steps_path, project_base_path, sign_in_path, sign_up_path, start_path } from './pages';
...
const Routes: React.FC = () => {
  ...
  return (
    <Switch>
      ...
      />
      <AuthRoute path={`${project_base_path}/:projectId/edit`} component={<ProjectEditor />} />
